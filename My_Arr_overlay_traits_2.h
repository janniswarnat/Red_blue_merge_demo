...
#ifndef MY_CGAL_ARR_OVERLAY_TRAITS_2_H
#define MY_CGAL_ARR_OVERLAY_TRAITS_2_H
...
public:
  ...
  typedef typename Arrangement_blue_2::Vertex_const_handle
                                                    Vertex_handle_blue;
  typedef typename Arrangement_red_2::Vertex_handle
  Vertex_handle;
  typedef typename Arrangement_red_2::Vertex_const_handle
  Vertex_const_handle;
  ...
  typedef typename Traits_2::Compare_y_at_x_left_2 Base_compare_y_at_x_left_2;//Jannis Warnat
   ...
   */
  typedef Tag_true                                 Has_left_category; //adapted by Jannis Warnat
  typedef Tag_false                                 Has_merge_category;
  typedef Tag_true                               Has_do_intersect_category; //CGAL 4.1
  
  // The color of a feature.
  enum Color
    {
      NOT_SET = 0,
      RED = 1, // From the "red" arrangement.
      BLUE = 2, // From the "blue" arrangement.
      RB_OVERLAP = 4, // Red-blue overlap.
      DUMMY = 8,
    };
...
public:
  ...
  /*! Default constructor. */
  My_Arr_overlay_traits_2()
  {}

  /*! Constructor from a base traits class. */
  My_Arr_overlay_traits_2 (const Traits_2 & base_tr) :
  ...
  class Ex_point_2
    ...
    protected:
      ...
      Object m_purple_obj; // the purple object
    ...
    public:
      ...
      const Object& purple_object() const
        {
          return (m_purple_obj);
        }
      ...
      bool is_purple_object_empty () const
        {
          return (m_purple_obj.is_empty());
        }
      ...
      void set_purple_object (const Object& obj_p)
        {
          m_purple_obj = obj_p;
        }
      ...
      Color color () const
        {
          ...
          Vertex_const_handle invalid_vh;

          if (!is_red_object_empty())
            {
              try
                {
                  vh = object_cast<Vertex_const_handle> (red_object());
                }
              ...
              if(vh->data().type() == DEFAULT)
                {
                  return RED;
                }

              if(vh->data().type() == POINT_X)
                {
                  return RED;
                }

              if(vh->data().type() == INTERNAL_ENDPOINT)
                {
                  return RED;
                }
              else
            ...
            {
              CGAL_assertion(!is_blue_object_empty());
              try
                {
                  vh = object_cast<Vertex_const_handle> (blue_object());
                }
              catch (Bad_object_cast)
                {
                  CGAL_assertion(false);
      ...
      // get the type the vertex will be in the purple arrangement
      Vertex_type purple_data ()
        {
          Vertex_const_handle vh;
          Vertex_const_handle invalid_vh;
          ...
          if (!is_red_object_empty())
            {
              ...
              if(vh->data().type() == INTERNAL_ENDPOINT)
                ...
                {
                  CGAL_assertion(vh->data().type() == EXTERNAL_ENDPOINT);
                  return INTERNAL_ENDPOINT;
                }
            }
          else
  ...
  class Ex_x_monotone_curve_2
    ...
    protected:
      ...
      Point_2 left_ex_point; // the left extended endpoint
      Point_2 right_ex_point; // the right extended endpoint
      bool left_set;
      bool right_set;
    ...
    public:
      ...
      void set_left_ex_point(Point_2 p)
        {
          left_ex_point = p;
          left_set = true;
        }

      void set_right_ex_point(Point_2 p)
        {
          right_ex_point = p;
          right_set = true;
        }
      ...
      Point_2 left()
        {
          return left_ex_point;
        }

      Point_2 right()
        {
          return right_ex_point;
        }

      bool left_is_set() const
        {
          return left_set;
        }

      bool right_is_set() const
        {
          return right_set;
        }
  ...
  friend std::ostream& operator<< (std::ostream& os,
    ...
    {
      os << "   [ (" << to_double(xcv.base().source().x()) << " " << to_double(xcv.base().source().y()) << ")(" << to_double(xcv.base().target().x()) << " " << to_double(xcv.base().target().y()) << ")] " << xcv.color() << " ";
      return (os);
    }
  ...
  friend std::ostream& operator<< (std::ostream& os,
      const Point_2& pt)
    {
      os << "   (" << to_double(pt.base().x()) << " " << to_double(pt.base().y()) << ")";
      return (os);
    }
...
//#endif
  ...
  protected:
    //! The base traits.
    const My_Arr_overlay_traits_2 * m_traits;
     ...
     * constructing it.
     */
    Intersect_2(const My_Arr_overlay_traits_2 * traits) : m_traits(traits) {}

    //! Allow its functor obtaining function calling the protected constructor.
    friend class My_Arr_overlay_traits_2<Traits_2,
                                      Arrangement_red_2,
                                      Arrangement_blue_2>;
  ...
  public:
    ...
    {
      return ARR_INTERIOR;//m_base->parameter_space_in_x_2_object() (xcv.base(), ce);
    }
...
//    }
  ...
  public:
    Arr_parameter_space operator() (const X_monotone_curve_2 & xcv,
                                    Arr_curve_end ce) const
    {
      return ARR_INTERIOR;//m_base->parameter_space_in_y_2_object()(xcv.base(), ce);
    }
